...
```bash
printf '%s' 'BASE64_HERE' | base64 -d > backend-frontpage.html
```
...
- you should see a dashboard heading and a link to `/admin/messages`
...
At this point the dashboard already shows a link pointing to `/admin/messages`.
